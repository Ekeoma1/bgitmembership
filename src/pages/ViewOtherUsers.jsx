...
const ViewOtherUsers = () => {
  ...
  useEffect(() => {
    ...
    dispatch(triggerGetAllPostsByUserId({ queryParams: { pageNumber, pageSize } }));
  }, []);
      ...
      <div className="container">
        ...
        <div className="row mt-5">
          <div className="col-lg-9 col-12">
            <ProfileBanner othersView={true} data={getUserByProfileId} />
            <BioCard othersView={true} data={getUserByProfileId} />
