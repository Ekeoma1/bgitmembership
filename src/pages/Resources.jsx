  ...
  return (
    <div className="resources-wrapper">
      <div className="search-box-section mx-auto">
        ...
        <button onClick={handleSearch} type="submit" className="primary-btn small-btn">
          Search
        </button>
      </div>
          ...
          {data.map((card) => (
            <div className="resource-card-component">
              ...
              <div className="card-btn-con">
                ...
                <button onClick={() => handleResourceCard(card.id)} className="card-btn">
                  Learn more
                </button>
                <button onClick={() => handleResourceCard(card.id)} className="card-btn-mobile">
