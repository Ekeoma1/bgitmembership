...
const PasswordResetForm = () => {
  ...
  return (
    <Formik
      ...
      validationSchema={step === 1 ? emailValidationSchema : step === 2 ? codeValidationSchema : passwordValidationSchema}
  ...
  return (
    <Form className="form-card mx-lg-0 mx-auto">
      <div>
        ...
        <TextInput name="code" label="Enter Code" type="number" placeholder="Input the code sent to your email" />
      </div>

      <div className="text-center">
        <div onClick={handleButtonClick} disabled={!isActive} className="other-action-btn mb-3">
  ...
  return (
    <Form className="form-card mx-lg-0 mx-auto">
      <div>
        ...
        <PasswordInput name="newPassword" label="New Password" placeholder="Input your new password" />
        <PasswordInput name="confirmNewPassword" label="Re-enter New Password" placeholder="Input your new password" />
      </div>
...
const ProceedToLogin = () => {
  return (
    <div className="form-card mx-lg-0 mx-auto">
      <header>
        <h2>Password Reset</h2>
        <div>Your password has been reset successfully , please proceed to login.</div>
      </header>
      <div className="text-center">
