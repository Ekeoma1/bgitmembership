    ...
    <div className="post-card shadow-sm mx-auto">
      <div className="post-card-header">
        <div className="post-owner-details">
          <div className="img-circle" onClick={() => navigate(`other-users/${post?.userId}`)}>
            <img
          ...
          <div>
            <div className="d-flex align-items-center">
              <span className="name" onClick={() => navigate(`other-users/${post?.userId}`)}>
                {post?.userName}
              </span>
      ...
      <div className="post-card-footer">
        <div className="post-card-footer-content">
          <div className="d-flex align-items-center c-gap-10">
            <button onClick={handleLike} className={`heart-icon ${liked && "active"}`}>
              <Icon icon="heart" />
            </button>
            <span>{Array.isArray(idsOfUsersWhoHaveLikedThePost) && idsOfUsersWhoHaveLikedThePost?.length}</span>
          </div>
